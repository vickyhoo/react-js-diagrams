...
var DiagramEngine = exports.DiagramEngine = function (_BaseEntity) {
  ...
  _createClass(DiagramEngine, [{
    ...
    value: function getRelativeMousePoint(event) {
      ...
      var _diagramModel$getZoom = this.diagramModel.getZoomLevel(),
    ...
    value: function getPortCenter(port) {
      ...
      var _diagramModel$getZoom3 = this.diagramModel.getZoomLevel(),
      ...
      var x = sourceElement.offsetWidth / 2 + rel.x / (zoomX / 100.0) - this.diagramModel.getOffsetX();
      var y = sourceElement.offsetHeight / 2 + rel.y / (zoomY / 100.0) - this.diagramModel.getOffsetY();
